...
void
CM_StoreLeafs(leafList_t * ll, int nodenum)
{
  int leafNum;
...
void
CM_StoreBrushes(leafList_t * ll, int nodenum)
{
  int i, k;
  int leafnum;
  int brushnum;
...
void
CM_FloodArea_r(int areaNum, int floodnum)
{
  int i;
  cArea_t *area;
  int *con;
...
*/
qboolean
CM_BoundsIntersectPoint(const vec3_t mins, const vec3_t maxs,
			const vec3_t point)
{
