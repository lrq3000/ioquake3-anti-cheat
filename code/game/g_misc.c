...
#ifdef MISSIONPACK
static void
PortalDie(gentity_t * self, gentity_t * inflictor, gentity_t * attacker,
	  int damage, int mod)
{
  G_FreeEntity(self);
...
DropPortalDestination(gentity_t * player)
{
  ...
  ent = G_Spawn();
  ent->s.modelindex =
    G_ModelIndex("models/powerups/teleporter/tele_exit.md3");
...
DropPortalSource(gentity_t * player)
{
  ...
  ent = G_Spawn();
  ent->s.modelindex =
    G_ModelIndex("models/powerups/teleporter/tele_enter.md3");
