...
// _ML_
  ...
  wh_bbox_horz = Cvar_Get("wh_bbox_horz", "30", CVAR_SYSTEMINFO);
  wh_bbox_vert = Cvar_Get("wh_bbox_vert", "60", CVAR_SYSTEMINFO);
  wh_add_xy = Cvar_Get("wh_add_xy", "0", CVAR_SYSTEMINFO);
  SV_InitWallhack();
#endif
// _ML_
