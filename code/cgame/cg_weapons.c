...
CG_MachineGunEjectBrass(centity_t * cent)
{
  ...
  le->endTime =
    le->startTime + cg_brassTime.integer +
...
CG_ShotgunEjectBrass(centity_t * cent)
{
  ...
  for (i = 0; i < 2; i++)
  {
    ...
    le->startTime = cg.time;
    le->endTime =
      le->startTime + cg_brassTime.integer * 3 +
...
CG_NailgunEjectBrass(centity_t * cent)
{
  ...
  smoke =
    CG_SmokePuff(origin, up, 32, 1, 1, 1, 0.33f, 700, cg.time, 0, 0,
...
CG_RegisterWeapon(int weaponNum)
{
  ...
  case WP_CHAINGUN:
    ...
    cgs.media.bulletExplosionShader =
      trap_R_RegisterShader("bulletExplosion");
    break;
#endif
  ...
  case WP_GRENADE_LAUNCHER:
    weaponInfo->missileModel =
      trap_R_RegisterModel("models/ammo/grenade1.md3");
    weaponInfo->missileTrailFunc = CG_GrenadeTrail;
    weaponInfo->wiTrailTime = 700;
    weaponInfo->trailRadius = 32;
    MAKERGB(weaponInfo->flashDlightColor, 1, 0.70f, 0);
...
//              weaponInfo->missileSound = trap_S_RegisterSound( "sound/weapons/nailgun/wnalflit.wav", qfalse );
    ...
    weaponInfo->missileModel =
      trap_R_RegisterModel("models/weaphits/nail.md3");
    MAKERGB(weaponInfo->flashDlightColor, 1, 0.75f, 0);
    weaponInfo->flashSound[0] =
...
//              weaponInfo->missileModel = cgs.media.invulnerabilityPowerupModel;
    ...
    cgs.media.plasmaExplosionShader =
      trap_R_RegisterShader("plasmaExplosion");
  ...
  case WP_BFG:
    ...
    weaponInfo->missileModel =
      trap_R_RegisterModel("models/weaphits/bfg.md3");
    weaponInfo->missileSound =
      trap_S_RegisterSound("sound/weapons/rocket/rockfly.wav", qfalse);
    break;
  ...
  if (cent->pe.barrelSpinning == !(cent->currentState.eFlags & EF_FIRING))
  {
    ...
    if (cent->currentState.weapon == WP_CHAINGUN && !cent->pe.barrelSpinning)
    {
      trap_S_StartSound(NULL, cent->currentState.number, CHAN_WEAPON,
			...
			("sound/weapons/vulcan/wvulwind.wav", qfalse));
    }
#endif
  }
