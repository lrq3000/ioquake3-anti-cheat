...
void
trap_S_StartSound(vec3_t origin, int entityNum, int entchannel,
		  sfxHandle_t sfx)
{
...
void
trap_S_AddLoopingSound(int entityNum, const vec3_t origin,
...
void
trap_R_AddPolyToScene(qhandle_t hShader, int numVerts,
...
void
trap_R_AddPolysToScene(qhandle_t hShader, int numVerts,
